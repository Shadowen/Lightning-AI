...
public class GameHandler {
	...
	public static Unit getClosestUnitOfType(int x, int y, UnitType type) {
		Unit closest = null;
	...
	public static Unit getClosestUnitOfType(int x, int y, UnitType... types) {
	...
	public static Unit getClosestEnemy(int x, int y) {
		double closestDistance = Double.MAX_VALUE;
	...
	public static Unit getClosestEnemy(Unit toWho) {
